            ...
            <div className="container mx-auto mx-w-5xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center text-secondary">
                    <div className="space-y-6">
                        ...
                        <p className="text-muted-foreground ">
                            With a strong willingness to learn and adapt to new technologies, I strive to become a capable web and application developer who adds real value to the company.
                        </p>
